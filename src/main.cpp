...
// Copyright (c) 2011-2013 PercivalCoin Developers.
...
const string strMessageMagic = "PercivalCoin Signed Message:\n";
...
static const int64 nTargetTimespan =  7 * 10 * 60; // PercivalCoin: 70 mins
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // PercivalCoin: This fixes an issue where a 51% attack can change difficulty at will.
    ...
    printf(" nActualTimespan = %"PRI64d" before bounds\n", nActualTimespan);        
         ...
         int64 nActualTimespanMax = ((nTargetTimespan*70)/55);
         int64 nActualTimespanMin = ((nTargetTimespan*55)/70);
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal PercivalCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PercivalCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc2, 0xad, 0xd6 }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // PercivalCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
